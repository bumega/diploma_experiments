...
def main() -> None:
    ...
    ensemble_specs: list[tuple[str, dict[str, Any]]] = [
        ...
        (
            "Ens_holdout_h64_m24_a240_c12_s8_ep20_cg010",
            {
                "d_hidden": 64,
                "n_hidden_layers": 2,
                "num_epochs": 20,
        ...
        (
            "Ens_holdout_h96_m32_a400_c14_s8_ep30_cg025",
            {
                "d_hidden": 96,
                "n_hidden_layers": 2,
                "num_epochs": 30,
        ...
        (
            "Ens_holdout_h96_m32_a400_c14_s8_ep30_cg010",
            {
                "d_hidden": 96,
                "n_hidden_layers": 2,
                "num_epochs": 30,
        ...
        (
            "Ens_cv5_h64_m8_a80_c12_s4_ep20_cg025",
            {
                "d_hidden": 64,
                "n_hidden_layers": 2,
                "num_epochs": 20,
        ...
        (
            "Ens_cv5_h64_m12_a120_c14_s4_ep20_cg010",
            {
                "d_hidden": 64,
                "n_hidden_layers": 2,
                "num_epochs": 20,
