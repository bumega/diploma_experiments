...
SEED = 41
Q = 5
RESULTS_ROOT = Path("quick_breal_search_ablation_stage2")
...
def _ensemble_factory(
    *,
    ...
    unary_params = {
        "d_hidden": d_hidden,
        "n_hidden_layers": n_hidden_layers,
        "num_epochs": max(10, min(num_epochs, 24)),
        "batch_size": batch_size,
        "checkpoint_every": 5,
        "checkpoint_n_grid": 19,
        "cG": cG,
...
def main() -> None:
    ...
    methods: list[tuple[str, object, dict]] = [
        (
            "PCA",
            lambda: PCAReducer(Q),
            {"d_hidden": 32, "n_hidden_layers": 2, "num_epochs": 8, "batch_size": 2048, "checkpoint_every": 5, "checkpoint_n_grid": 19, "cG": 0.25, "seed": SEED, "device": "cuda"},
        ),
        (
            "PLS",
            lambda: PLSReducer(Q),
    ...
    ensemble_specs = [
        ("Ens_best_prev_models12_attempts80_cg050", dict(d_hidden=32, n_hidden_layers=2, num_epochs=8, batch_size=2048, num_models=12, num_attempts=80, num_coords=5, num_samples=10, cG=0.50)),
        ...
        ("Ens_hidden64_models12_attempts80_cg050", dict(d_hidden=64, n_hidden_layers=2, num_epochs=20, batch_size=2048, num_models=12, num_attempts=80, num_coords=5, num_samples=10, cG=0.50)),
        ("Ens_hidden64_models16_attempts120_cg050", dict(d_hidden=64, n_hidden_layers=2, num_epochs=20, batch_size=2048, num_models=16, num_attempts=120, num_coords=5, num_samples=10, cG=0.50)),
        ("Ens_hidden64_models16_attempts160_cg050", dict(d_hidden=64, n_hidden_layers=2, num_epochs=20, batch_size=2048, num_models=16, num_attempts=160, num_coords=5, num_samples=10, cG=0.50)),
        ("Ens_hidden64_models20_attempts200_cg050", dict(d_hidden=64, n_hidden_layers=2, num_epochs=20, batch_size=2048, num_models=20, num_attempts=200, num_coords=5, num_samples=10, cG=0.50)),
        ("Ens_hidden64_models16_attempts160_coords6_cg050", dict(d_hidden=64, n_hidden_layers=2, num_epochs=20, batch_size=2048, num_models=16, num_attempts=160, num_coords=6, num_samples=12, cG=0.50)),
        ("Ens_hidden64_models16_attempts160_coords7_cg050", dict(d_hidden=64, n_hidden_layers=2, num_epochs=20, batch_size=2048, num_models=16, num_attempts=160, num_coords=7, num_samples=14, cG=0.50)),
        ("Ens_hidden96_models16_attempts160_cg050", dict(d_hidden=96, n_hidden_layers=2, num_epochs=20, batch_size=2048, num_models=16, num_attempts=160, num_coords=5, num_samples=10, cG=0.50)),
        ("Ens_hidden64_models16_attempts160_cg075", dict(d_hidden=64, n_hidden_layers=2, num_epochs=20, batch_size=2048, num_models=16, num_attempts=160, num_coords=5, num_samples=10, cG=0.75)),
    ]
